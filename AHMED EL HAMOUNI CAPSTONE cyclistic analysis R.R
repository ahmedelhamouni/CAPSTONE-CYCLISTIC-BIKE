...
df_032023 <- read.csv("202303-divvy-tripdata.csv")
df_042023 <- read.csv("202304-divvy-tripdata.csv")
df_052023 <- read.csv("202305-divvy-tripdata.csv")
...
df_cyclistic <- rbind(df_062022, df_072022, 
                      df_082022, df_092022, 
                      df_102022, df_112022, 
                      df_122022, df_032023, 
                      df_042023, df_052023, 
